...
parser.add_argument('--a3mdir', type= str, help = 'Path to directory with merged a3m files.')
parser.add_argument('--mode', type= str, default='top', help = 'Selection mode: top/bottom/all/random100.')
...
# ids2 = []
neffs = []
for a3m_file in a3mdir.glob('*.a3m'):
    try:
        msa = read_a3m(a3m_file)
    except:
        continue
...
out_file = outdir / f'neff_{mode}.csv'
