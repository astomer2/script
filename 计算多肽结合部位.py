...
if __name__ == '__main__':
    protein = r"C:\Users\123\Desktop\jobwork\subject\ADIPOR1\对接结果验证\hpep\64eefe2eb7a31\rec_64eefe2eb7a31.pdb"

    protein_xml = r"C:\Users\123\Desktop\jobwork\subject\ADIPOR1\对接结果验证\Q9VCY8.xml"
    output_path= r"C:\Users\123\Desktop\jobwork\subject\ADIPOR1\对接结果验证\output1.csv"
    cutoffs = 7
    
#    peptide = r"C:\Users\123\Desktop\jobwork\subject\ADIPOR1\对接结果验证\hpep\64eefe2eb7a31\model_1.pdb"
...
#    output_result(output_path, residuesB, TM_rate, EC_rate, IC_rate)
    ...
    peptide_dir = r"C:\Users\123\Desktop\jobwork\subject\ADIPOR1\对接结果验证\hpep\64eefe2eb7a31"
    for peptides in os.listdir(peptide_dir):
        if 'model' in peptides and peptides.endswith('.pdb'):
