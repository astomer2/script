...
from MD_utils import extract_three_letter_code
from MD_utils import reference_id
from MD_utils import target_id
from MD_utils import identify_cys_id
from MD_utils import change_cys_to_cyx
from MD_utils import check_last_residue_for_OXT
...
def sovlate_pdb(
    ...
    if all_atom:
        ...
        if pepcyc :
            ...
            if check_last_residue_for_OXT(peptide_structure):
